...
### Step 5: Write `circuit_logic.json`
...
> Extract the complete netlist from this schematic. Run the geometry extraction, then review
> every tile visually and transcribe the low-confidence labels before writing
> circuit_logic.json. I want every net to list all of its member terminals.
